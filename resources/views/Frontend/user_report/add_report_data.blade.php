...
<section class="content">
    <div class="container" style="min-height: 400px;">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        ...
                        <div class="box-tools pull-right">
                            <a href="{{url('user/report')}}" class="btn btn-info btn-sm">Reports List</a>
                        </div>
                    </div>
                    <p id="msg_main"></p>
                ...
                <form class="form-horizontal" id="frm_report_data" name="frm_report_data" action="" method="post" onsubmit="return false;">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Create new Report Data</h5>
        ...
        <!--        modal-->
        <div class="modal" id="sub_report_data_modal" tabindex="-1" role="dialog"  aria-hidden="true">
            <div class="modal-dialog" >
                <div class="modal-content">
...
<!--        <div class="modal" id="sub_report_data_modal" role="dialog">
            <div class="modal-dialog">
...
<script src="{!! asset(ASSET.'js/frontend/reports_data.js')!!}"></script>
