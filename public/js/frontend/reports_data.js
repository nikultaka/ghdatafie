...
//            console.log(div);
            ...
            $.ajax({
                type: "POST",
                url: BASE_URL +'/user/report/subsort',
                data: $("#report_sortable_form").serialize(),
...
//                    report_data_list();
    ...
    function report_data_list(){
        ...
        $.ajax({
            url: BASE_URL +'/user/report/reportdata_list',
            type: 'POST',
            data: {_token: frontend.common.get_csrf_token_value(),report_id:report_id},
            success: function (data) {
    ...
    function edit_sub_report(){
        $(".edit_subreport_data").on('click',function(){
            ...
            $.ajax({
                url: BASE_URL +'/user/report/edit_subreportdata',
                type: 'POST',
    ...
    function delete_report(){
        ...
        $(".delete_report_data").on('click',function(){
            ...
            if(confirm("Are you sure ?")){
                if (id > 0) {
                    $.ajax({
                        url: BASE_URL +'/user/report/delete_reportdata',
                        type: 'POST',
                        data: {_token: frontend.common.get_csrf_token_value(), id: id},
                        success: function (data) {
    ...
    function delete_sub_report(){
        ...
        $(".delete_subreport_data").on('click',function(){
            ...
            if(confirm("Are you sure ?")){
                if (id > 0) {
                    $.ajax({
                        url: BASE_URL +'/user/report/delete_subreportdata',
                        type: 'POST',
                        data: {_token: frontend.common.get_csrf_token_value(), id: id},
                        success: function (data) {
    ...
    $(document).ready(function () {
        ...
        $(".sub_subrep_data").on('click',function(){
            $.validate({
                ...
                onSuccess: function () {
                    $.ajax({
                        url: BASE_URL +'/user/report/subreportdata',
                        type: 'POST',
        ...
        $(".sub_rep_data").on('click',function(){
            $.validate({
                ...
                onSuccess: function () {
                    ...
                    $.ajax({
                        url: BASE_URL +'/user/report/reportdata',
                        type: 'POST',
        ...
        $("body").on('click','.edit_report_data',function(){
            ...
            $.ajax({
                url: BASE_URL +'/user/report/edit_reportdata',
                type: 'POST',
                data: {_token: frontend.common.get_csrf_token_value(),id:id},
                success: function (data) {
