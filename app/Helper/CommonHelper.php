    ...
    public static function get_breadcrumb()
    {
        ...
        if(!empty(self::$breadcrumn_data)){
            foreach(self::$breadcrumn_data as $breadcrumb){
                if($breadcrumb['url'] != ''){
                    $breadcrumb_str .= '<li class="breadcrumb-item"><a href="'.$breadcrumb['url'].'">'.ucfirst($breadcrumb['name']).'</a></li>';
                }else{
                    $breadcrumb_str .= '<li class="breadcrumb-item">'.ucfirst($breadcrumb['name']).'</li>';
                }
            }
        }
        $breadcrumb_str .= '</ol>';
