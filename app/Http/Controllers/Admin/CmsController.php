...
class CmsController extends Controller {
    ...
    public function edit($id) {
        ...
        return view("Admin.cms.add")->with($data);
    }
    ...
    public function cms_data_table() {
    $lang_id = CommonHelper::get_selected_language();
        ...
        foreach ($cms_list as $row) {
            ...
            $action = '<div class="datatable_btn" style="display:flex;"><a href="edit/' . $id . '" data-id="' . $id . '" class="btn btn-xs btn-info btnEdit_cms"> Edit</a>  	&nbsp;';
