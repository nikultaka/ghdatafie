...
//        $this->middleware('admin');
    ...
    public function store(Request $request) {
        ...
        if (!empty($post)) {
            ...
            if (isset($post['id']) && $post['id'] != '') {
                ...
                if (DB::table('site_setting_option')->insert($data)) {
                    $result['status'] = 1;
    ...
    public function edit(Request $request) {
        ...
        if (!empty($post)) {
            ...
            if ($id != "") {
                ...
                $adv_set = DB::table('site_setting_option')
                                ->where('id', '=', $id)->first();
    ...
    public function getdatatable() {
        ...
        $select_query = DB::table('site_setting_option')->where('status', '1');
